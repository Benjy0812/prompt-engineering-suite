As an expert DevOps engineer, your task is to generate a `Dockerfile` for a given application. The `Dockerfile` should be optimized for security, performance, and small image size.
